...
## [11.0.2 beta] - 2026-08-28

### Fixed

- Applied isolation for potentially conflicting js libraries.

## [11.0.1] - 2026-07-09

### Changed

- Switched from AMD to ESM for Rendering Service 2 web component

### [11.0.0] - 2026-06-16

## Changed

- Moved rendering logic to the ES activity plugin
- Bumped the Moodle branch to 5.2 in gitlab CI pipeline
...
- Filter can now detect and render embedded Edu-Sharing widgets

### [10.1.2] - 2026-01-26

## Fixed

- Link to Edu-Sharing repository now uses the rendering proxy

## Changed

- Plugin now requires Moodle 4.5.0 or higher

### [10.1.1] - 2025-12-09

## Added

- Version parameter added to secured node AJAX call

## Fixed

- Code style now matches updated moodle criteria
